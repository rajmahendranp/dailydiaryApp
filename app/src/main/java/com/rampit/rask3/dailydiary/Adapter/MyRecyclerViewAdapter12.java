...
public class MyRecyclerViewAdapter12 extends RecyclerView.Adapter<com.rampit.rask3.dailydiary.Adapter.MyRecyclerViewAdapter12.ViewHolder> implements Filterable {
    ...
    public MyRecyclerViewAdapter12(Context context, List<String> data, ArrayList<String> ID, Integer integer , Collection collection) {
...
//                        String number = pos.replaceAll("[^0-9]", "");
                        Log.d("newdebit", pos);
                       collection.inte(d,d1,String.valueOf(getAdapterPosition()));
                    }
                }
            });
        }
