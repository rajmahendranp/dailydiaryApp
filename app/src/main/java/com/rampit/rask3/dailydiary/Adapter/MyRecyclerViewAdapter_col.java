...
public class MyRecyclerViewAdapter_col extends RecyclerView.Adapter<MyRecyclerViewAdapter_col.ViewHolder> implements Filterable {
    ...
    public MyRecyclerViewAdapter_col(Context context, List<String> data, ArrayList<Long> ID, Collection collection) {
