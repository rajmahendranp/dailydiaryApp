...
public class RecyclerViewAdapter_num extends RecyclerView.Adapter<com.rampit.rask3.dailydiary.Adapter.RecyclerViewAdapter_num.ViewHolder> implements Filterable {
    ...
    public RecyclerViewAdapter_num(Context context, List<String> data , List<String> data2 , Settings_activity settings_activity , String path , String tyypp) {
...
//        holder.num.setText(spl[1]);
        holder.num.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                settings_activity.show_filee(path+mm,"Daily");
            }
        });
        if(position %2 == 1)
        {
