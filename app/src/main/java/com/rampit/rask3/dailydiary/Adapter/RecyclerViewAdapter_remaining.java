...
public class RecyclerViewAdapter_remaining extends RecyclerView.Adapter<com.rampit.rask3.dailydiary.Adapter.RecyclerViewAdapter_remaining.ViewHolder> implements Filterable {
    ...
    public RecyclerViewAdapter_remaining(Context context, List<String> data) {
...
// method notifyDataSetChanged () allows you to update the list on the screen after filtration
    ...
    @Override
    public com.rampit.rask3.dailydiary.Adapter.RecyclerViewAdapter_remaining.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.recyclerview_rowrem, parent, false);
        return new com.rampit.rask3.dailydiary.Adapter.RecyclerViewAdapter_remaining.ViewHolder(view);
    }

    // binds the data to the TextView in each row
    @Override
    public void onBindViewHolder(com.rampit.rask3.dailydiary.Adapter.RecyclerViewAdapter_remaining.ViewHolder holder, int position) {
...
//        holder.mpaid.setText(sSss1);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        private TextView mTitle,mid,mbal;
