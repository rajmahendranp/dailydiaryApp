...
public class RecyclerViewAdaptercurrent extends RecyclerView.Adapter<RecyclerViewAdaptercurrent.ViewHolder> implements Filterable {
    ...
    public RecyclerViewAdaptercurrent(Context context, List<String> data) {
