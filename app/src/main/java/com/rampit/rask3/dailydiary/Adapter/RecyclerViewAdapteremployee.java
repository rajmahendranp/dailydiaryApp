...
import com.rampit.rask3.dailydiary.Add_employee;
...
public class RecyclerViewAdapteremployee extends RecyclerView.Adapter<RecyclerViewAdapteremployee.MyViewHolder> implements Filterable {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView mTitle,mid;
        private Button edit,nip,payment,delet;
        View rowView;
...
//            database = sqlite.getWritableDatabase();
    ...
    public RecyclerViewAdapteremployee(ArrayList<String> data, Integer in, Context context, String edpr, String depr) {
        this.data = data;
        datafull = data;
...
// method notifyDataSetChanged () allows you to update the list on the screen after filtration
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.recyclerview_row8, parent, false);
                ...
                alertbox.setPositiveButton(del,
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface arg0,
                                ...
                                sqlite = new SQLiteHelper(context);
                                database = sqlite.getWritableDatabase();
                                String table = "dd_employee";
                                String whereClause = "id=?";
                                String[] whereArgs = new String[] {num};
                                database.delete(table, whereClause, whereArgs);
                                sqlite.close();
                                database.close();
                                Intent name= new Intent(context, Employee_details.class);
...
//                String num = String.valueOf();
                Log.d("editpos",num);
                Intent name= new Intent(context, Add_employee.class);
