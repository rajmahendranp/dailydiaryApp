...
public class RecyclerViewAdapternip extends RecyclerView.Adapter<RecyclerViewAdapternip.ViewHolder> implements Filterable {
    ...
    public RecyclerViewAdapternip(Context context, List<String> data) {
...
// method notifyDataSetChanged () allows you to update the list on the screen after filtration
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        private TextView mTitle,mid,mDeb,mbal,mpaid;
