...
public class RecyclerViewAdaptertotalaccounts1 extends RecyclerView.Adapter<RecyclerViewAdaptertotalaccounts1.ViewHolder> implements Filterable {

    private List<String> mData;
    private List<String> mDatachange;
    private LayoutInflater mInflater;
    Context context;
    com.rampit.rask3.dailydiary.Fragment.delete_data_fragment delete_data_fragment;


    // data is passed into the constructor
    public RecyclerViewAdaptertotalaccounts1(Context context, List<String> data , delete_data_fragment delete_data_fragment) {
        this.mInflater = LayoutInflater.from(context);
        this.context = context;
        this.mData = data;
        this.delete_data_fragment = delete_data_fragment;
        mDatachange = mData;
    }
    @Override
...
//        }
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(accttt>1){
                    delete_data_fragment.closing_acc(s);
                }
            }
        });
