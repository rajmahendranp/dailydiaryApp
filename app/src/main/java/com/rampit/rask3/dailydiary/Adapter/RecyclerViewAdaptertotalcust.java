...
public class RecyclerViewAdaptertotalcust extends RecyclerView.Adapter<RecyclerViewAdaptertotalcust.ViewHolder> implements Filterable {
    ...
    public RecyclerViewAdaptertotalcust(Context context, List<String> data) {
...
// method notifyDataSetChanged () allows you to update the list on the screen after filtration
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.recyclerview_rowtotal, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        private TextView mTitle,mid,mloc;
        ...
        ViewHolder(View itemView) {
            ...
            mloc = itemView.findViewById(R.id.location);
        }
