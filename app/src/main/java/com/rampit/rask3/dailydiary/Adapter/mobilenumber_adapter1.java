...
public class mobilenumber_adapter1 extends RecyclerView.Adapter<mobilenumber_adapter1.ViewHolder> implements Filterable {
    ...
    public mobilenumber_adapter1(Context context, List<String> data , Collection bulkupdate) {
