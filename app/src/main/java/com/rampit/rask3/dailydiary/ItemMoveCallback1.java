...
//    }
    ...
    private void reallyMoved(RecyclerView.ViewHolder viewHolder,int from, int to) {
        ...
        RecyclerViewAdapter.MyViewHolder myViewHolder1=
...
//    }
    ...
    public interface ItemTouchHelperContract {
        ...
        void onRowSelected(RecyclerViewAdapter.MyViewHolder myViewHolder, int position);
        void onRowClear(RecyclerViewAdapter.MyViewHolder myViewHolder, int position);
        void oncle(RecyclerViewAdapter.MyViewHolder myViewHolder,int from,int to);
    }
