...
//populateRecyclerView() - get all NIP users

public class NIP_activity extends AppCompatActivity {
...
//            recreate();
        ...
        dialog = new Dialog(NIP_activity.this,R.style.AlertDialogTheme);
                ...
                handler.post(new Runnable() {
                    public void run() {
                        try {
                            ...
                            if (InternetConnection1.checkConnection(getApplicationContext(),NIP_activity.this)) {
                                // Internet Available...
                                Log.d("internet","on");
                                showinng = 0;
                            }
...
//        populateRecyclerView();
    ...
    public static class InternetConnection1 {
        ...
        public static boolean checkConnection(Context context, final NIP_activity account) {
...
//        dialog.getWindow().requestFeature(Window.FEATURE_NO_TITLE);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_back) {
            Intent back = new Intent(NIP_activity.this,ReportActivity.class);
            startActivity(back);
            finish();
            return true;
        }
...
Log.d("or21",total1);
                    ...
                    ball2 = ball2 + Integer.parseInt(total);
                    if(debtyp == 2){
                        Names.add(oid +","+ name +","+debit +","+ total+","+vaa);
                    }else{
                        Names.add(id +","+ name +","+debit +","+ total+","+vaa);
                    }
