...
public class SendMail1 extends AsyncTask<Void,Void,Void> {
    ...
    //Class Constructor
    public SendMail1(Context context, String email, String subject, String message, String pdfFile , String pdfname){
