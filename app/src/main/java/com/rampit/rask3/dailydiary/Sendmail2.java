...
public class Sendmail2 extends AsyncTask<Void,Void,Void> {
    ...
    ProgressDialog progressDialogq;
    ...
    protected void onPreExecute() {
        ...
        progressDialogq= new ProgressDialog(context,R.style.AlertDialogTheme);
        progressDialogq.setMessage("Sending Message"+" "+"Please Wait .....");
        progressDialogq.setCancelable(false);
        progressDialogq.show();
//        progressDialogq = ProgressDialog.show(context,"Sending message","Please wait...",false,false,R.style.AppTheme);
    }
